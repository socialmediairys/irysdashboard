...
-- Conexão final: uma Página do Facebook + Conta Business do Instagram vinculada.
...
-- Passo intermediário: quando o usuário administra mais de uma Página do
-- Facebook, guardamos aqui a lista de páginas encontradas (com seus tokens)
-- até o usuário escolher qual conectar. Some assim que a escolha é feita.
